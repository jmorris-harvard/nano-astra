...
void send_flow(int src_id, int dst, int maxPacketCount,
	       ...
	       // new
	       // changed to std_function
               void (*msg_handler)(void *fun_arg), void *fun_arg, int tag, std::function<void (void *)> callback
	       // ---- Jalil ----
	       ) {
  ...
  RdmaClientHelper clientHelper(
      ...
      // new
      global_t == 1 ? maxRtt : pairRtt[src_id][dst], callback, nullptr, tag,
      // ---- Jalil ----
      src_id, dst);
