...
int main(int argc, char* argv[]) {
    ...
    for (int npu_id = 0; npu_id < num_npus; npu_id++) {
        ...
        cout << "system " << npu_id << " done..." << endl;
    }

    // Initialize ns3 simulation.
    // ---- Jalil ----
    cout << "setting up ns3 simulation..." << endl;
    // ---- Jalil ----
