...
CommunicatorGroup::CommunicatorGroup(int id,
                                     ...
                                     Sys* generator) {
    // ---- Jalil ----
    std::cout << "comm group creation start..." << std::endl;
    // ---- Jalil ----
    set_id(id);
    // ---- Jalil ----
    std::cout << "comm group creation step 0..." << std::endl;
    // ---- Jalil ----
    this->involved_NPUs = involved_NPUs;
    this->generator = generator;
    // ---- Jalil ----
    std::cout << "comm group creation step 1..." << std::endl;
    // ---- Jalil ----
    ...
    // ---- Jalil ----
    std::cout << "comm group creation done..." << std::endl;
    // ---- Jalil ----
}
