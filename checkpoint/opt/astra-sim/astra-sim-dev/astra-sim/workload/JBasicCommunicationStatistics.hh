#ifndef __J_BASIC_COMMUNICATION_STATISTICS_HH__
#define __J_BASIC_COMMUNICATION_STATISTICS_HH__
...
class BasicCommunicationStatistics : public StatisticsProcessor {
  public:
    BasicCommunicationStatistics (void);
  ...
  private:
    ...
    std::vector<CommunicationBlock> _blocks;
    std::map<std::pair<unsigned, unsigned>, unsigned> _portUsage; 
