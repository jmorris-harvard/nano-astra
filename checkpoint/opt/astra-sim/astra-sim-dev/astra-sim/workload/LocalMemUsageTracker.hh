...
class LocalMemUsageTracker {
 public:
  ...
  void recordStart(const std::shared_ptr<Chakra::FeederV3::ETFeederNode> node, Tick tick);
  void recordEnd(const std::shared_ptr<Chakra::FeederV3::ETFeederNode> node, Tick tick);
 ...
 private:
  void recordReads(const std::shared_ptr<Chakra::FeederV3::ETFeederNode> node, Tick start, Tick end);
  void recordWrites(const std::shared_ptr<Chakra::FeederV3::ETFeederNode> node, Tick start, Tick end);
