  ...
  if (!stream)
    {
      ...
      asciiTraceHelper.HookDefaultPhyTxBeginSinkWithoutContext<QbbNetDevice> (device, "PhyTxBegin", theStream);
      asciiTraceHelper.HookDefaultPhyTxEndSinkWithoutContext<QbbNetDevice> (device, "PhyTxEnd", theStream);
      asciiTraceHelper.HookDefaultPhyRxEndSinkWithoutContext<QbbNetDevice> (device, "PhyRxEnd", theStream);
