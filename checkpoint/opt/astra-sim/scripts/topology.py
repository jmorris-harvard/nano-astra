...
def main ():
  ...
  parser.add_argument ('-k','--pods', default=2,
          help = 'number indpendent connections per switch (fattree/leafspine/jellyfish)')
  parser.add_argument ('-N','--ports', default=40,
          help = 'number ports on chosen switch (fattree/leafspine/jellyfish)')
  parser.add_argument ('-R','--racks', default=4,
          help = 'number ToR switches (jellyfish)')
  parser.add_argument ('-r','--interconnects', default=2,
          help = 'number connections between ToR and other ToR')
